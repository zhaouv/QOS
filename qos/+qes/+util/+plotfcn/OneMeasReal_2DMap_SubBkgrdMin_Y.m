function [varargout] = OneMeasReal_2DMap_SubBkgrdMin_Y(Data, SweepVals,ParamNames,MainParam,MeasurementName,AX,IsPreview)
   % plot function for data:
   % OneMeasReal_2DMap_SubBkgrd_Y plots 3D spectrum data to a 2D map with color scale
   % for the third dimension, subtract background((minimun value) along the y axes(the firs sweep).
