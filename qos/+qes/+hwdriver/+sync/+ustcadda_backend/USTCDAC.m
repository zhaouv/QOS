...
%                 obj.SetOffset(k-1,obj.offset(k));
                ...
                obj.SetDefaultVolt(k-1,-obj.offsetcorr(k)+32768);
            end
        end
       ...
       % 该函数未使用
        ...
        function WriteWave(obj,ch,offset,wave)
            ...
            if(mod(len,32) ~= 0)
                ...
                data = zeros(1,len)+32768+obj.offsetcorr(ch);
       ...
       function SetDefaultVolt(obj,channel,volt)
        ...
        function value = get(obj,properties)
            switch lower(properties)
                ...
                case 'offsetcorr'; value = obj.offsetcorr;
        ...
        function set(obj,properties,value)
             switch lower(properties)
                ...
                case 'channel_amount'; 
                    ...
                    obj.offsetcorr = zeros(1,obj.channel_amount);
