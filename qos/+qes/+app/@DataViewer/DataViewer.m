...
% mail4ywu@gmail.com/mail4ywu@icloud.com
    ...
    properties (SetAccess = private, GetAccess = private) % the following properties are managered internally.
    ...
    properties (Constant = true, GetAccess = private)
        ...
        availableplotfcns = {'Data specified or default','OneMeas_Def','OneMeasReal_1D_Mkr',...
            ...
            'sparam.Amplitude','sparam.Phase','T1'};
    ...
    methods
        ...
        function set.currentfile(obj,val)
            ...
            obj.loadeddata = {};
            for ii = 1:length(obj.previewfiles)
                idx = find(obj.previewfiles(ii)==previewfiles_old,1);
                if (isempty(obj.changed2newlst) || ~obj.changed2newlst) && ~isempty(idx);
                      obj.loadeddata{ii} = loadeddata_old{idx};
                else
                    try
                        load(obj.datafiles_full{obj.files2show(obj.previewfiles(ii))});
                        temp.Data = Data;
