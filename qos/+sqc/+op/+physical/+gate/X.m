classdef X < sqc.op.physical.gate.XY_base
...
% mail4ywu@gmail.com/mail4ywu@icloud.com
    ...
    methods
        function obj = X(qubit)
            obj = obj@sqc.op.physical.gate.XY_base(qubit);
            obj.logical_op = sqc.op.logical.gate.X;
...
%                             obj.logical_op = sqc.op.logical.gate.X;
%                         else
%                             obj.logical_op = sqc.op.logical.gate.X.*obj.logical_op;
%                         end
%                     else
%                         if ii == 1
...
%             end
            ...
            obj.amp = obj.qubits{1}.g_X_amp;
        end
    end
    methods (Hidden = true)
        function GenWave(obj)
            GenWave@sqc.op.physical.gate.XY_base(obj);
            obj.xy_wv{1}.phase = obj.qubits{1}.g_XY_phaseOffset;
        end
    end
end