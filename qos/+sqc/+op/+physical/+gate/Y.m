classdef Y < sqc.op.physical.gate.XY_base
...
% mail4ywu@gmail.com/mail4ywu@icloud.com
    ...
    methods
        function obj = Y(qubit)
            obj = obj@sqc.op.physical.gate.XY_base(qubit);
            obj.logical_op = sqc.op.logical.gate.Y;
...
%                             obj.logical_op = sqc.op.logical.gate.Y;
%                         else
%                             obj.logical_op = sqc.op.logical.gate.Y.*obj.logical_op;
%                         end
%                     else
%                         if ii == 1
