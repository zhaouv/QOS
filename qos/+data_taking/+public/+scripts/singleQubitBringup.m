...
q3zAmp2f01 = @(x)q1zAmp2f01(x-55500);
q3zAmp2f01 =@(x) -5.809e-10*x.^2 + 3.312e-5*x + 5.401;
spectroscopy1_zpa_bndSwp('qubit','q3',...
       'swpBandCenterFcn',q3zAmp2f01,'swpBandWdth',100e6,...
       'biasAmp',[-1500:250:32500],'driveFreq',[4.8e9:0.1e6:6.0e9],...
       'gui',true,'save',true);
