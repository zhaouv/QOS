...
dips = [6.84364, 6.80418, 6.790, 6.7618,6.719, 6.682]*1e9; % by qubit idex
...
s21_rAmp('qubit','q2','freq',[dips(2)-0.75e6:0.03e6:dips(2)+0.75e6],'amp',[logspace(log10(1000),log10(32768),25)],...
