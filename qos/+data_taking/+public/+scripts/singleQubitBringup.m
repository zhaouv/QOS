...
for ii = 9:10
s21_rAmp('qubit',qubits{ii},'freq',[dips(ii)-2e6:0.05e6:dips(ii)+1e6],'amp',[logspace(log10(1000),log10(32768),25)],...  % logspace(log10(1000),log10(32768),25)
      'notes','attenuation:26dB','gui',true,'save',true);
end
%%
s21_zdc('qubit', 'q4',...
...
%        'gui',false,'save',true);
spectroscopy1_zpa_s21('qubit','q2',...
       'biasAmp',[-2e4:5e3:2e4],'driveFreq',[5.8e9:0.20e6:6.05e9],...
       'gui',false,'save',true);
for ii = 5:10
