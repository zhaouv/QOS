...
dips = [6.84364, 6.80418, 6.790, 6.7618,6.719, 6.682]*1e9+200e6; % by qubit idex
...
s21_rAmp('qubit','q2','freq',[dips(1)-0.75e6:0.03e6:dips(1)+0.75e6],'amp',[logspace(log10(1000),log10(32768),25)],...
      'notes','attenuation:26dB','gui',true,'save',true);
%% spectroscopy1_zpa_s21
spectroscopy1_zpa_s21('qubit','q2',...
       'biasAmp',fliplr([-10000:400:4000]),'driveFreq',[6.05e9:0.05e6:6.075e9]+200e6,...
       'notes','','gui',true,'save',true);
% f01 = 6.0651e9;
% % f01 = 5.962e9;
% spectroscopy1_zpa_s21('qubit','q2',...
%        'biasAmp',[0],'driveFreq',[f01-1e6:0.02e6:f01+1e6]+200e6,...
