...
%%
ramsey('qubit','q2','mode','df01',... % available modes are: df01, dp and dz
      'time',[0:10:4e2],'detuning',[5]*1e6,...
      'dataTyp','P','notes','','gui',true,'save',true);
%%
spin_echo('qubit','q7','mode','df01',... % available modes are: df01, dp and dz
      'time',[0:16:2e3],'detuning',[-5]*1e6,...
      'notes','','gui',true,'save',true);
%%
T1_1('qubit','q7','biasAmp',[0,100],'biasDelay',16,'time',[0:160*2:20e3],...
      'gui',true,'save',true);
%%
