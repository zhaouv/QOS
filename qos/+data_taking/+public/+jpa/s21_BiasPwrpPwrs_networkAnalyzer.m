...
% Yulin Wu, 2017/2/14
    ...
    fcn_name = 'data_taking.public.jpa.s21_BiasPwrpPwrs_networkAnalyzer'; % this and args will be saved with data
    import qes.*
    ...
    if ~isa(na,'qes.hwdriver.sync.networkAnalyzer') && ~isa(na,'qes.hwdriver.async.networkAnalyzer')
        throw(MException('s21_BiasPwrpPwrs_networkAnalyzer:inValidSettings',...
